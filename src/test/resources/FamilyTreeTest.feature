Feature: FamilyTreeTest
  ...
  Scenario Outline: Two people are getting married
    ...
    Examples:
      | person1 | person2 | level | female | male |
  ...
  Scenario Outline: Two people are cousins
    ...
    Examples:
    | person1 | person2 | person3  | person4  | person5 | person6  | male | female | level | childrenLevel | grandChildLevel |
    | Chris   | Marie   | Isabella | Michael  | Jon     | Anabelle | male | female | 1     | 2             | 3               |
